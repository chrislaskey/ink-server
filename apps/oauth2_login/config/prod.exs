...
# OAuth2LoginWeb.Endpoint.init/2 when load_from_system_env is
...
config :oauth2_login, OAuth2LoginWeb.Endpoint,
  ...
  url: [host: "oauth2.example.com", port: 80],
...
# start per endpoint:
#
#     config :oauth2_login, OAuth2LoginWeb.Endpoint, server: true
#

config :oauth2_login.Repo,
  ...
  database: System.get_env("OAUTH2_LOGIN_POSTGRES_DB"),
  pool_size: 15
